...
<section id="static-header" class="jumbotron" role="info">
	<div class="container-fluid">
		<div class="row-fluid text-center">
			<div id="static-header-image" class="span6 hidden-phone">
				<figure>
					<img src="<?php echo esc_url( $t_em_theme_options['static-header-img-url'] ); ?>"
			...
			<div id="static-header-text" class="span6">
