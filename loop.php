...
<?php /* How to display posts in the Gallery category. */ ?>
	...
	<?php if ( in_category( _x('gallery', 'gallery category slug', 't_em') ) ) : ?>
...
?>
				...
				<p><em><?php printf( __( 'This gallery contains <a %1$s>%2$s photos</a>.', 't_em' ),
						'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 't_em' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
						$total_images
					); ?></em></p>
...
<?php endif; ?>
			...
			<footer class="entry-utility">
				<a href="<?php echo get_term_link( _x('gallery', 'gallery category slug', 't_em'), 'category' ); ?>" title="<?php esc_attr_e( 'View posts in the Gallery category', 't_em' ); ?>"><?php _e( 'More Galleries', 't_em' ); ?></a>
...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 't_em') ) ) : ?>
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
