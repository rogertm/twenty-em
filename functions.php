...
function t_em_lessphp_compiler( $less_files, $options = array(), $modify_vars = array(), $delete_garbage = true ){
	...
	if ( ! is_writable( $parent_dir ) ) :
		$error = sprintf( __( '%s can not create a cache directory for compiled css files in <strong><code>%s</code></strong>. Make this directory writable before continue.<br />
